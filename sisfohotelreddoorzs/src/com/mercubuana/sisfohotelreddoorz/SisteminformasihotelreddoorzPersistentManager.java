...
public class SisteminformasihotelreddoorzPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "Sisteminformasihotelreddoorz";
	...
	private SisteminformasihotelreddoorzPersistentManager() throws PersistentException {
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new SisteminformasihotelreddoorzPersistentManager();
		}
